...
localparam WBPI_WORDBITSZ         = 256/* RAM WORDBITSZ */;
...
localparam IRQ_SERIAL   = (IRQ_GPIO + 1);
...
localparam RAMCACHESZ = /* In (WORDBITSZ/8) units */
	((1024/(WORDBITSZ/8))*(256/RAMCACHEWAYCNT));
...
assign s_wbpi_mapsz_w[S_WBPI_RAM] = ('h40000000/* 1GB */);
