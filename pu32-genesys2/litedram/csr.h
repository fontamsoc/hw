//--------------------------------------------------------------------------------
// Auto-generated by LiteX (1989d85b) on 2022-04-13 16:13:27
//--------------------------------------------------------------------------------
...
static inline uint64_t sdram_dfii_pi2_wrdata_read(void) {
	uint64_t r = csr_read_simple(CSR_BASE + 4180L);
	r <<= 32;
...
static inline uint64_t sdram_dfii_pi2_rddata_read(void) {
	uint64_t r = csr_read_simple(CSR_BASE + 4188L);
	r <<= 32;
...
static inline uint64_t sdram_dfii_pi3_wrdata_read(void) {
	uint64_t r = csr_read_simple(CSR_BASE + 4212L);
	r <<= 32;
...
static inline uint64_t sdram_dfii_pi3_rddata_read(void) {
	uint64_t r = csr_read_simple(CSR_BASE + 4220L);
	r <<= 32;
