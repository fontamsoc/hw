...
create_clock -name clk200mhz_p -period 5 -waveform {0 2.5} [get_ports clk200mhz_p]
...
## LEDs
set_property -dict { PACKAGE_PIN T28   IOSTANDARD LVCMOS33 } [get_ports { activity }]; #IO_L11N_T1_SRCC_14 Sch=led[0]
