## Created from: https://github.com/Digilent/digilent-xdc/blob/master/Arty-A7-100-Master.xdc

## Clock signal
set_property -dict { PACKAGE_PIN E3 IOSTANDARD LVCMOS33 } [get_ports { clk100mhz_i }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100]
