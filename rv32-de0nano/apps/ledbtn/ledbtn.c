...
volatile uintptr_t* const leds[] = {
	(void*)0xd80, (void*)0xd90, (void*)0xda0, (void*)0xdb0,
	(void*)0xdc0, (void*)0xdd0, (void*)0xde0, (void*)0xdf0};
...
void blink (void *) {
	...
	uintptr_t dutypct = 0;
	uintptr_t idx = 0;
	uintptr_t idxdir = 0; // 0 = ascend, 1 = descend.
	...
	while (1) {
		if (blink_en || stepdir != 0 || dutypct != 0) {
			if (dutypct >= 100) {
				...
				dutypct = 100;
			pwm_onpulse[idxdir ? ((countof(leds) - 1)  - idx) : idx] =
				(((stepdir ? (100 - dutypct) : dutypct) * pwm_period) / 100);
		}
