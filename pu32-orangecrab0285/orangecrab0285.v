...
localparam WBPI_WORDBITSZ         = 128/* RAM WORDBITSZ */;
...
wire [(WBPI_WORDBITSZ/8) -1 : 0] dcache_wb_cdc_wb_sel_w;
wire [WBPI_WORDBITSZ -1 : 0]     dcache_wb_cdc_wb_dato_w;
wire                             dcache_wb_cdc_wb_bsy_w;
wire                             dcache_wb_cdc_wb_ack_w;
wire [WBPI_WORDBITSZ -1 : 0]     dcache_wb_cdc_wb_dati_w;
...
wire [(WORDBITSZ/8) -1 : 0] ramctrl_wb_cdc_wb_sel_w;
wire [WORDBITSZ -1 : 0]     ramctrl_wb_cdc_wb_dato_w;
reg                         ramctrl_wb_cdc_wb_bsy_r;
wire                        ramctrl_wb_cdc_wb_ack_w;
wire [WORDBITSZ -1 : 0]     ramctrl_wb_cdc_wb_dati_w;
