...
localparam CLOG2SWORDBITSZ = clog2(SWORDBITSZ);
...
generate if (MWORDBITSZ > SWORDBITSZ) begin :gen_dnsizr
	...
	assign m_wb_dat_o = ({{(MWORDBITSZ-SWORDBITSZ){1'b0}}, _s_wb_dat_i} <<
		{_s_wb_addr_o[(CLOG2MWORDBITSZBY8-CLOG2SWORDBITSZBY8) -1 : 0], {CLOG2SWORDBITSZ{1'b0}}});

	assign s_wb_dat_o = {m_wb_dat_i >>
		{s_wb_addr_o[(CLOG2MWORDBITSZBY8-CLOG2SWORDBITSZBY8) -1 : 0], {CLOG2SWORDBITSZ{1'b0}}}};
