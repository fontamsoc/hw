...
`include "lib/core_usb_cdc/src_v/usbf_device_core.sv"
`include "lib/core_usb_cdc/src_v/usbf_sie_rx.sv"
`include "lib/core_usb_cdc/src_v/usbf_sie_tx.sv"
`include "lib/core_usb_cdc/src_v/usbf_crc16.sv"
`include "lib/core_usb_fs_phy/src_v/usb_fs_phy.sv"
`include "lib/core_usb_fs_phy/src_v/usb_transceiver.sv"
