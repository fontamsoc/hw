...
// Devices mapsz must be at a minimum aligned to ARCHBITSZ, for s_wb_sel_o
...
wire [ARCHBITSZ -1 : 0] s_wb_addr_o_ = (_m_wb_addr_i - addrspace_slvidx_lo);
...
assign s_wb_addr_o[((gen_s_wb_idx+1) * ADDRBITSZ) -1 : (gen_s_wb_idx * ADDRBITSZ)] =
	s_wb_addr_o_[ARCHBITSZ -1 : CLOG2ARCHBITSZBY8];
