...
wire                                         m_wbpi_lock_w [WBPI_MASTERCOUNT];
...
wire                                         s_wbpi_lock_w  [WBPI_SLAVECOUNT];
...
wire [(1 * WBPI_MASTERCOUNT) -1 : 0]                              _m_wbpi_lock_w;
...
wire [(1 * WBPI_SLAVECOUNT) -1 : 0]                              s_wbpi_lock_w__;
...
wire                                         s_wbpi_lock_w_ [WBPI_SLAVECOUNT];
