...
`ifndef FIFO_FWFT_ASYNC_V
`define FIFO_FWFT_ASYNC_V
...
reg [(CLOG2DEPTH +1) -1 : 0] gray_readidx;
reg [(CLOG2DEPTH +1) -1 : 0] gray_writeidx;
...
// Two flip-flop synchronizer moving gray_readidx into "clk_push_i".
...
always_ff @(posedge clk_push_i) begin // Synchronize gray_readidx to clk_push_i.
...
// Two flip-flop synchronizer moving gray_writeidx into "clk_pop_i";
...
always_ff @(posedge clk_pop_i) begin // Synchronize gray_writeidx to clk_pop_i.
