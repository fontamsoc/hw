...
create_clock -add -name clk100mhz_i -period 10.00 [get_ports {clk100mhz_i}];
create_clock -add -name clk50mhz -period 20.00 [get_nets {clk50mhz}];
create_clock -add -name clk100mhz -period 10.00 [get_nets {clk100mhz}];
create_clock -add -name clk200mhz -period 5.00 [get_nets {clk200mhz}];
set_clock_groups -asynchronous -group [get_clocks {clk100mhz_i}]
set_clock_groups -asynchronous -group [get_clocks {clk50mhz}]
set_clock_groups -asynchronous -group [get_clocks {clk100mhz}]
set_clock_groups -asynchronous -group [get_clocks {clk200mhz}]
...
## LEDs
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { activity }]; #IO_L18P_T2_A24_15 Sch=led[0]
...
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { rst2_i }]; #IO_L9P_T1_DQS_14 Sch=btnc
